            ...
            >
              ...
              >
                ...
                <div class="movie-info text-center text-md-start">
                  ...
                  <router-link :to="`/movie/${movie.movieId}`" class="btn btn-warning btn-lg">🎟️ Đặt vé ngay</router-link>
                </div>
              </div>
            </div>
          </div>
...
const videos = [
  { id: 1, title: "YAMAHA PG-1 ABS 2025 - RỰC RỠ PHIÊU LƯU", thumbnail: "https://via.placeholder.com/600x400?text=Video+1" },
